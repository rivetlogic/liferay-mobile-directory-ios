...
//TODO:  I couldn't get the out-of-the-box split view controller code to load up at this point.  So I just bypassed it and loaded the MasterViewController (see below).  Need to fix this so it works on iPad.
    ...
    func login() {
        let controller = Storyboards.Login.Storyboard().instantiateViewControllerWithIdentifier("Login") as? LoginViewController
        if let window = self.window {
            window.rootViewController = controller
            window.makeKeyAndVisible()
        }
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.rivetlogic.MobilePeopleDirectory.MobilePeopleDirectory" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("MobilePeopleDirectory", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("MobilePeopleDirectory.sqlite")
